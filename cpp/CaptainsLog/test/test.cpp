...
DEFINE_CAP_LOG_CHANNEL(RENDER, 0, FULLY_ENABLED)
  DEFINE_CAP_LOG_CHANNEL(RENDER_SUB_CHANNEL_A, 0, FULLY_ENABLED, RENDER)
  DEFINE_CAP_LOG_CHANNEL(RENDER_SUB_CHANNEL_A_VERBOSE, 5, FULLY_ENABLED, RENDER)
  DEFINE_CAP_LOG_CHANNEL(RENDER_SUB_CHANNEL_B, 2, FULLY_ENABLED, RENDER)
DEFINE_CAP_LOG_CHANNEL(NETWORK, 0, FULLY_ENABLED)
DEFINE_CAP_LOG_CHANNEL(AUDIO, 0, FULLY_ENABLED)
  DEFINE_CAP_LOG_CHANNEL(AUDIO_SUB_CHANNEL_Z, 0, FULLY_ENABLED, AUDIO)
  DEFINE_CAP_LOG_CHANNEL(AUDIO_SUB_CHANNEL_OTHER, 2, FULLY_ENABLED, AUDIO)
  DEFINE_CAP_LOG_CHANNEL(AUDIO_IO, 3, FULLY_ENABLED, AUDIO)
DEFINE_CAP_LOG_CHANNEL(MISC, 0, FULLY_ENABLED)
DEFINE_CAP_LOG_CHANNEL(SET_THIS_EXAMPLE, 0, FULLY_ENABLED)
DEFINE_CAP_LOG_CHANNEL(SET_ADDRESS_EXAMPLE, 0, FULLY_ENABLED)
DEFINE_CAP_LOG_CHANNEL(SET_STORE_NAME_EXAMPLE, 0, ENABLED_NO_OUTPUT)
DEFINE_CAP_LOG_CHANNEL(LAMBDA_EXAMPLE, 0, FULLY_ENABLED)
DEFINE_CAP_LOG_CHANNEL(ENABLED_CHANNEL, 0, FULLY_ENABLED)
DEFINE_CAP_LOG_CHANNEL(NO_OUTPUT_CHANNEL, 0, ENABLED_NO_OUTPUT)
DEFINE_CAP_LOG_CHANNEL(DISABLED_CHANNEL, 0, FULLY_DISABLED)
  DEFINE_CAP_LOG_CHANNEL(CHANNEL_ENABLED_BUT_SHOULD_BE_DISABLED_IN_LOG, 0, ENABLED_NO_OUTPUT, DISABLED_CHANNEL)
    DEFINE_CAP_LOG_CHANNEL(CHANNEL_ENABLED_BUT_SHOULD_BE_DISABLED_IN_LOG_2, 0, FULLY_ENABLED, CHANNEL_ENABLED_BUT_SHOULD_BE_DISABLED_IN_LOG)
DEFINE_CAP_LOG_CHANNEL(NESTED_CHANNEL, 0, FULLY_ENABLED)

DEFINE_CAP_LOG_CHANNEL(PARENT1, 0, FULLY_ENABLED)
DEFINE_CAP_LOG_CHANNEL(PARENT2, 0, ENABLED_NO_OUTPUT)
  DEFINE_CAP_LOG_CHANNEL(CHILD1, 0, FULLY_ENABLED, PARENT1, PARENT2)
...
int main() {
  ...
  std::cout << "PARENT1 " << CAP_CHANNEL_OUTPUT_MODE(CAP::CHANNEL::PARENT1) << std::endl;
  std::cout << "PARENT2 " << CAP_CHANNEL_OUTPUT_MODE(CAP::CHANNEL::PARENT2) << std::endl;
  std::cout << "CHILD1 " << CAP_CHANNEL_OUTPUT_MODE(CAP::CHANNEL::CHILD1) << std::endl;
