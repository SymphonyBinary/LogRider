...
DEFINE_CAP_LOG_CHANNEL(RENDER, 0, FULLY_ENABLED)
  DEFINE_CAP_LOG_CHANNEL_CHILD(RENDER_SUB_CHANNEL_A, 0, FULLY_ENABLED, RENDER)
  DEFINE_CAP_LOG_CHANNEL_CHILD(RENDER_SUB_CHANNEL_A_VERBOSE, 5, FULLY_ENABLED, RENDER)
  DEFINE_CAP_LOG_CHANNEL_CHILD(RENDER_SUB_CHANNEL_B, 2, FULLY_ENABLED, RENDER)
DEFINE_CAP_LOG_CHANNEL(NETWORK, 0, FULLY_ENABLED)
DEFINE_CAP_LOG_CHANNEL(AUDIO, 0, FULLY_ENABLED)
  DEFINE_CAP_LOG_CHANNEL_CHILD(AUDIO_SUB_CHANNEL_Z, 0, FULLY_ENABLED, AUDIO)
  DEFINE_CAP_LOG_CHANNEL_CHILD(AUDIO_SUB_CHANNEL_OTHER, 2, FULLY_ENABLED, AUDIO)
  DEFINE_CAP_LOG_CHANNEL_CHILD(AUDIO_IO, 3, FULLY_ENABLED, AUDIO)
...
DEFINE_CAP_LOG_CHANNEL(DISABLED_CHANNEL, 0, FULLY_DISABLED)
  DEFINE_CAP_LOG_CHANNEL_CHILD(CHANNEL_ENABLED_BUT_SHOULD_BE_DISABLED_IN_LOG, 0, ENABLED_NO_OUTPUT, DISABLED_CHANNEL)
    DEFINE_CAP_LOG_CHANNEL_CHILD(CHANNEL_ENABLED_BUT_SHOULD_BE_DISABLED_IN_LOG_2, 0, FULLY_ENABLED, CHANNEL_ENABLED_BUT_SHOULD_BE_DISABLED_IN_LOG)
