...
DEFINE_CAP_LOG_CHANNEL(CHANNEL_ONE, 2, FULLY_ENABLED)
  DEFINE_CAP_LOG_CHANNEL_CHILD(CHANNEL_TWO, 5, FULLY_DISABLED, CHANNEL_ONE)
    DEFINE_CAP_LOG_CHANNEL_CHILD(CHANNEL_TWO_B, 8, FULLY_ENABLED, CHANNEL_TWO) 
  DEFINE_CAP_LOG_CHANNEL_CHILD(CHANNEL_THREE, 8, FULLY_ENABLED, CHANNEL_ONE)
    DEFINE_CAP_LOG_CHANNEL_CHILD(CHANNEL_THREE_B, 4, ENABLED_NO_OUTPUT, CHANNEL_THREE)
      DEFINE_CAP_LOG_CHANNEL_CHILD(CHANNEL_THREE_C, 4, FULLY_ENABLED, CHANNEL_THREE_B)
